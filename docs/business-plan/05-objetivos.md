...
* Cubrir el OPEX directo normalizado y validar el modelo productivo, tecnológico y comercial durante el primer ciclo, sin exigir al piloto la recuperación del CAPEX (véase [Validación del piloto](./18-validacion-del-piloto.md)).
...
- [Documento anterior: Selección del modelo productivo](./04-modelo-productivo.md)
- [Documento siguiente: Modelo modular de crecimiento](./06-crecimiento-modular.md)
