---
title: "Funciones del agente inteligente"
project: "NidoSmart"
...
# Funciones del agente inteligente
...
- [Documento anterior: Evaluación técnica de Hermes Agent y Paperclip](./11-hermes-agent-y-paperclip.md)
- [Documento siguiente: Seguridad funcional y ciberseguridad](./13-seguridad-y-ciberseguridad.md)
