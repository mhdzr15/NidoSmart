---
title: "Justificación de la oportunidad"
project: "NidoSmart"
...
- [Documento anterior: Descripción del negocio](./02-descripcion-del-negocio.md)
- [Documento siguiente: Selección del modelo productivo](./04-modelo-productivo.md)
